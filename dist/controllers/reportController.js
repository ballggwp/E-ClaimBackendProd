...
exports.generateMonthlyReportCPM = void 0;
const client_1 = require("@prisma/client");
const exceljs_1 = __importDefault(require("exceljs"));
const prisma = new client_1.PrismaClient();
const generateMonthlyReportCPM = async (req, res, next) => {
    try {
        ...
        const records = await prisma.claim.findMany({
            ...
            select: {
                ...
                history: {
                    where: {
                        status: { in: [client_1.ClaimStatus.PENDING_USER_CONFIRM, client_1.ClaimStatus.COMPLETED] }
                    },
        ...
        for (const c of records) {
            ...
            const mgrHist = c.history.find(h => h.status === client_1.ClaimStatus.PENDING_USER_CONFIRM);
            const compHist = c.history.find(h => h.status === client_1.ClaimStatus.COMPLETED);
...
exports.generateMonthlyReportCPM = generateMonthlyReportCPM;
